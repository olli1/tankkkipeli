...
public class VihollisUkkeliAmpuu : MonoBehaviour {
	...
	void Update () {
		...
		if (jaahyAjastin <= 0 && player !=null && Vector3.Distance(transform.position,player.position)<9&&GetComponent<VihollisUkkeliSkripti1>().inRange) 
		{
